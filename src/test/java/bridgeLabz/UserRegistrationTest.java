...
public class UserRegistrationTest {
    ...
    @Test
    void givenFirstNameShouldReturnTrue() throws InvalidFirstNameShouldReturnTrue{
    ...
    @Test
    void givenLastNameReturnTrue() throws InvalidLastNameReturnTrue{
    ...
    @Test
    void givenEmailRerurnTrue() throws InvalidEmailRerurnTrue{
    ...
    @Test
    void givenMobileNumberRerurnTrue() throws InvalidMobileNumberRerurnTrue{
    ...
    @Test
    void givenPasswordRerurnTrue() throws InvalidPasswordRerurnTrue{
